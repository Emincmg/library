    ...
    public function run()
    {
        ...
        Book::create(
            [
                ...
                'author' => 'Leo Tolstoy',
                'explanation' => "The Death of Ivan Ilyich (also Romanized Ilich, Ilych, Ilyitch; Russian: Смерть Ивана Ильича, romanized: Smert' Ivána Ilyicha), first published in 1886, is a novella by Leo Tolstoy, considered one of the masterpieces of his late fiction, written shortly after his religious conversion of the late 1870s.",
                'category' => ['Novel', 'Fiction'],
                'img' => 'https://upload.wikimedia.org/wikipedia/commons/1/1b/The_Death_of_Ivan_Ilyich.jpg',
                'date' => '1902-01-01',
                'stock' => 7
            ]
        );
        ...
        Book::create([
            ...
            'explanation' => "Brave New World is a dystopian novel by English author Aldous Huxley, published in 1932. The novel is set in a futuristic World State, where citizens are divided into castes and conditioned to conform to society's strict social norms and values. The story follows the protagonist, Bernard Marx, as he struggles to find his place in a society that values conformity above all else. The novel explores themes of individualism, freedom, and the dangers of a society that prioritizes efficiency and pleasure over humanity.",
        ...
        Book::create([
            ...
            'explanation' => "Nineteen Eighty-Four is a dystopian novel by George Orwell, published in 1949. The novel is set in a totalitarian society where individualism is forbidden and conformity is enforced by the government. The protagonist, Winston Smith, works at the Ministry of Truth where he rewrites historical records to conform with the party's propaganda. The novel explores themes of government oppression, the dangers of totalitarianism, and the importance of individual freedom.",
        ...
        Book::create([
            ...
            'category' => ['Novel', 'Historical Fiction'],
            'img' => 'https://upload.wikimedia.org/wikipedia/en/5/5b/GoodEarthNovel.JPG',
            'date' => '1931-03-02',
            'stock' => 4
        ]);
        Book::create([
            'title' => 'The Hobbit',
            'author' => 'J.R.R. Tolkien',
            'explanation' => "The Hobbit, or There and Back Again is a children's fantasy novel by English author J.R.R. Tolkien. It was published on 21 September 1937 to wide critical acclaim, being nominated for the Carnegie Medal and awarded a prize from the New York Herald Tribune for best juvenile fiction. The book remains popular and is recognized as a classic in children's literature.",
            'category' => ['Novel', 'Fantasy'],
            'img' => 'https://m.media-amazon.com/images/I/71k--OLmZKL._AC_UF1000,1000_QL80_.jpg',
            'date' => '1937-09-21',
            'stock' => 8
        ]);
        Book::create([
            ...
            'author' => 'Nathaniel Hawthorne',
            'explanation' => "The House of the Seven Gables is a Gothic novel written by American author Nathaniel Hawthorne and published in April 1851. The novel follows a New England family and their ancestral home. In the book, Hawthorne explores themes of guilt, retribution, and atonement and colors the tale with suggestions of the supernatural and witchcraft.",
            'category' => ['Novel', 'Gothic'],
            'img' => 'https://upload.wikimedia.org/wikipedia/commons/e/ea/The_House_of_the_Seven_Gables.jpg',
            'date' => '1851-04-01',
            'stock' => 5
        ]);
        Book::create([
            'title' => 'Animal Farm',
            'author' => 'George Orwell',
            'explanation' => "Animal Farm is an allegorical novella by George Orwell, first published in England on 17 August 1945. The book tells the story of a group of farm animals who rebel against their human farmer, hoping to create a society where the animals can be equal, free, and happy. Ultimately, however, the rebellion is betrayed, and the farm ends up in a state as bad as it was before, under the dictatorship of a pig named Napoleon. The novella is widely regarded as a critique of Stalinism and totalitarianism.",
            'category' => ['Novel', 'Satire'],
            'img' => 'https://upload.wikimedia.org/wikipedia/commons/f/fb/Animal_Farm_-_1st_edition.jpg',
            'date' => '1945-08-17',
            'stock' => 10
        ]);
        Book::create([
        ...
        Book::create([
            ...
            'explanation' => "The Old Man and the Sea is a short novel written by Ernest Hemingway in 1951 in Cuba, and published in 1952. It tells the story of Santiago, an aging Cuban fisherman who struggles with a giant marlin far out in the Gulf Stream off the coast of Cuba. The novel explores themes of struggle, perseverance, and the relationship between humans and nature.",
            'category' => ['Novel', 'Fiction'],
            'img' => 'https://upload.wikimedia.org/wikipedia/en/7/73/Oldmansea.jpg',
            'date' => '1952-09-01',
            'stock' => 12
        ]);
        Book::create([
        ...
        Book::create([
            ...
            'img' => 'https://upload.wikimedia.org/wikipedia/en/2/25/A_Separate_Peace_cover.jpg',
            'date' => '1959-01-01',
            'stock' => 5
        ]);
        Book::create([
        ...
        Book::create([
            'title' => 'Julius Caesar',
            'author' => 'William Shakespeare',
            'explanation' => "Julius Caesar is a tragedy by William Shakespeare, believed to have been written in 1599. It portrays the conspiracy against the Roman dictator Julius Caesar, his assassination, and its aftermath. It is one of several Roman plays that Shakespeare wrote, based on true events from Roman history, which also include Coriolanus and Antony and Cleopatra.",
            'category' => ['Tragedy', 'Historical Fiction'],
            'img' => 'https://upload.wikimedia.org/wikipedia/commons/a/ab/Edwin_Austin_Abbey_-_Within_the_Tent_of_Brutus%2C_Enter_the_Ghost_of_Caesar%2C_Julius_Caesar%2C_Act_IV%2C_Scene_III_-_1937.1148_-_Yale_University_Art_Gallery.jpg',
            'date' => '1599',
            'stock' => 9
        ]);
        Book::create([
        ...
        Book::create([
            ...
            'explanation' => "Inferno is the first part of Italian writer Dante Alighieri's 14th-century epic poem Divine Comedy. It is followed by Purgatorio and Paradiso. The Inferno tells the journey of Dante through Hell, guided by the ancient Roman poet Virgil. In the poem, Hell is depicted as nine concentric circles of torment located within the Earth. It is the most famous and widely studied of the three parts, and its vivid descriptions of the punishments meted out to various sinners have helped to shape the popular idea of Hell.",
            'category' => ['Epic poetry', 'Allegory'],
            'img' => 'https://upload.wikimedia.org/wikipedia/commons/f/f0/Inferno.jpg',
            'date' => '1320',
            'stock' => 5
        ]);
        Book::create([
            ...
            'img' => 'https://img.kitapyurdu.com/v1/getImage/fn:9788677/wh:true/miw:200/mih:200',
            'date' => '1606',
            'stock' => 3
        ]);
        Book::create([
            'title' => 'Othello',
            'author' => 'William Shakespeare',
            'explanation' => "Othello is a tragedy by William Shakespeare, believed to have been written in 1603. It is based on the story Un Capitano Moro by Cinthio, a disciple of Boccaccio, first published in 1565. The story revolves around its two central characters: Othello, a Moorish general in the Venetian army, and his unfaithful ensign, Iago. The play is set in a city-state, Venice, during the early modern period, and explores themes such as love, jealousy, betrayal, revenge, and racism.",
            'category' => ['Tragedy', 'Drama'],
            'img' => 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Henry_Perronet_Briggs_-_Ira_Aldridge_as_Othello_-_Google_Art_Project.jpg/386px-Henry_Perronet_Briggs_-_Ira_Aldridge_as_Othello_-_Google_Art_Project.jpg',
            'date' => '1603',
            'stock' => 6
        ]);
        Book::create([
            'title' => 'Antigone',
            'author' => 'Sophocles',
            'explanation' => 'Antigone is a tragedy by Sophocles written in or before 441 BC. It is the third of the three Theban plays chronologically, but was the first written. The play expands on the Theban legend that predated it and picks up where Aeschylus\' Seven Against Thebes ends.',
            'category' => ['Tragedy', 'Classical literature'],
            'img' => 'https://m.media-amazon.com/images/I/81-BiXpotuL._AC_UF1000,1000_QL80_.jpg',
            'date' => '441',
            'stock' => 9
        ]);
        Book::create([
            'title' => 'Oedipus Rex',
            'author' => 'Sophocles',
            'explanation' => "Oedipus Rex, also known by its Greek title, Oedipus Tyrannus, or Oedipus the King, is an Athenian tragedy by Sophocles that was first performed around 429 BC. The play tells the story of Oedipus, the king of Thebes, who unwittingly kills his father and marries his mother. When Oedipus discovers the truth about his past, he blinds himself and goes into exile. The play is considered a masterpiece of ancient Greek drama and is one of the most famous plays of all time.",
            'category' => ['Tragedy', 'Greek Drama'],
            'img' => 'https://upload.wikimedia.org/wikipedia/commons/6/69/Oedipus.jpg',
            'date' => '429 BC',
            'stock' => 4
        ]);
        Book::create([
        ...
        Book::create([
            ...
            'img' => 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Alice%27s_Adventures_in_Wonderland_cover_%281865%29.jpg',
            'date' => '1865-11-26',
            'stock'=> 6
        ]);
        Book::create([
