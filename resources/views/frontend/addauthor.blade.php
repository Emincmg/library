    ...
    <section class="inner-page">
        <div class="container">
            <div class="addauthor-container">
                <div class="form">
                    <form action="addauthor" method="post" enctype="multipart/form-data" role="form" id="addAuthorForm"
                          class="add-author-form">
                        @csrf
                        ...
                        <textarea class="form-control" name="author_explanation" id="author_explanation" rows="5"
                                  placeholder="Author explanation"
                                  required></textarea>
                        </div>
                        <div class="form-group mt-3">
                            ...
                            <div class="form-group mt-3">
                                <div class="row mt-3">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input class="form-control" name="author_born" type="date" id="author_born"
                                               required>
                                    </div>
                                    <div class="col-md-6 form-group">
