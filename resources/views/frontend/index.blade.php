...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <h1 class="logo"><a href="index.html">Library</a></h1>
                ...
                <div class="carousel-item" style="background-image: url(assets/img/slide/slide-3.jpg);">
                    <div class="carousel-container">
                        <div class="carousel-content">
                            ...
                            <div>
                                <a href="https://github.com/Emincmg/library" class="btn-get-started animate__animated animate__fadeInUp scrollto">GitHub</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
                    <div class="count-box">
                        <i class='bx bx-book-open'></i>
                        <span data-purecounter-start="0" data-purecounter-end="{{$bookCount}}" data-purecounter-duration="1" class="purecounter"></span>
                ...
                <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
                    <div class="count-box">
                        <i class='bx bx-user-pin' ></i>
                        <span data-purecounter-start="0" data-purecounter-end="{{$authorCount}}" data-purecounter-duration="1" class="purecounter"></span>
...
{{--            </div>--}}
            ...
            <div class="row portfolio-container">
                ...
                <div class="col-lg-2 col-md-5 portfolio-item filter-card">
                    <div class="portfolio-wrap rounded-1">
                        <img src="{{url($book->book_img)}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4></h4>
                            <p>{{$book->book_title}}</p>
                            <div class="portfolio-links">
                                <a href="{{url($book->book_img)}}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="{{$book->book_title}}"><i class="bx bx-plus"></i></a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-4 col-md-6">
                    <div class="member">
                        <img src="{{url($author->author_img)}}" class="img-fluid" alt="">
...
<footer id="footer">
    ...
    <div class="container">
        ...
        <div class="credits">
            ...
            Designed by <a href="https://bootstrapmade.com/">Ali Emin Çomoğlu</a>
        </div>
    </div>
</footer><!-- End Footer -->
