                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="mt-3">
                                ...
                                <a href="{{route('editprofilepage')}}"><button class="custom-button positive">Edit Profile</button></a>
                ...
                <div class="row gutters-sm">
                    <div class="card mb-3">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap"><h6>Latest added user books</h6></li>
                            @foreach($lastBooks as $book)
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <p style="font-size: 14px" class="mb-0">{{$book->title}}</p>
                                    <span style="font-size: 14px" class="text-secondary">{{$book->created_at}}</span>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="card mb-3">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap"><h6>Latest added user notes</h6></li>
