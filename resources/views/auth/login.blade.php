                ...
                <div class="login-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-16 d-flex justify-content-center">
                            <a class="btn btn-outline-dark" href="{{url('auth/google')}}" role="button" style="text-transform:none; font-size: 14px">
                                <img src="" alt="">
                                <img width="20px" style="margin-bottom:3px; margin-right:5px" alt="Google sign-in" src="{{asset('/assets/img/google.png')}}" />
                                Login with Google
                            </a>
                        </div>
                    </div>
